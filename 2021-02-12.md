...
+ [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)(**137 stars today**): A list of useful payloads and bypass for Web Application Security and Pentest/CTF
...
+ [jina](https://github.com/jina-ai/jina)(**65 stars today**): An easier way to build neural search on the cloud
+ [howdy](https://github.com/boltgolt/howdy)(**28 stars today**): 🛡️Windows Hello™ style facial authentication for Linux
+ [awx](https://github.com/ansible/awx)(**49 stars today**): AWX Project
...
+ [jax](https://github.com/google/jax)(**20 stars today**): Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
...
+ [doccano](https://github.com/doccano/doccano)(**11 stars today**): Open source text annotation tool for machine learning practitioner.
...
+ [angr](https://github.com/angr/angr)(**6 stars today**): A powerful and user-friendly binary analysis platform!
...
+ [pytorch-forecasting](https://github.com/jdb78/pytorch-forecasting)(**10 stars today**): Time series forecasting with PyTorch
...
+ [mlkit](https://github.com/googlesamples/mlkit)(**42 stars today**): A collection of sample apps to demonstrate how to use Google's ML Kit APIs on Android and iOS
...
+ [cryptomator](https://github.com/cryptomator/cryptomator)(**2 stars today**): Multi-platform transparent client-side encryption of your files in the cloud
...
## unknown
+ [awesome-libra](https://github.com/reed-hong/awesome-libra)(**222 stars today**): A Curated List of Awesome Facebook Libra Resources
...
+ [a32nx](https://github.com/flybywiresim/a32nx)(**72 stars today**): The A32NX Project is a community driven open source project to create a free Airbus A320neo in Microsoft Flight Simulator that is as close to reality as possible. It aims to enhance the default A320neo by improving the systems depth and functionality to bring it up to payware-level, all for free.
+ [bootstrap](https://github.com/twbs/bootstrap)(**21 stars today**): The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
+ [QuantumultX](https://github.com/w37fhy/QuantumultX)(**8 stars today**): 同步和更新大佬脚本库，更新懒人配置
+ [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)(**124 stars today**): 🛁Clean Code concepts adapted for JavaScript
...
+ [react-select](https://github.com/JedWatson/react-select)(**18 stars today**): The Select Component for React.js
...
+ [mdx](https://github.com/mdx-js/mdx)(**13 stars today**): JSX in Markdown for ambitious projects
+ [wtfjs](https://github.com/denysdovhan/wtfjs)(**16 stars today**): 🤪A list of funny and tricky JavaScript examples
+ [react-map-gl](https://github.com/visgl/react-map-gl)(**5 stars today**): React friendly API wrapper around MapboxGL JS
...
## html
+ [supercookie](https://github.com/jonasstrehle/supercookie)(**104 stars today**): ⚠️Browser fingerprinting via favicon!
...
+ [Formulario](https://github.com/rafaballerini/Formulario)(**2 stars today**): Página de formulário com HTML e CSS
...
+ [cheapeth-website](https://github.com/geohot/cheapeth-website)(**8 stars today**): 
...
+ [MeshCentral](https://github.com/Ylianst/MeshCentral)(**1 stars today**): This is a full computer management web site. With MeshCentral, you can run your own web server and it to remotely manage and control computers on a local network or anywhere on the internet. Once you get the server started, will create a mesh (a group of computers) and then download and install a mesh agent on each computer you want to manage. A…
...
## go
+ [vault](https://github.com/hashicorp/vault)(**187 stars today**): A tool for secrets management, encryption as a service, and privileged access management
+ [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws)(**26 stars today**): Terraform AWS provider
+ [learngo](https://github.com/inancgumus/learngo)(**64 stars today**): 1000+ Hand-Crafted Go Examples, Exercises, and Quizzes
...
+ [presidio](https://github.com/microsoft/presidio)(**9 stars today**): Context aware, pluggable and customizable data protection and anonymization service for text and images
...
+ [scope](https://github.com/weaveworks/scope)(**4 stars today**): Monitoring, visualisation & management for Docker & Kubernetes
...
+ [image-spec](https://github.com/opencontainers/image-spec)(**4 stars today**): OCI Image Format
