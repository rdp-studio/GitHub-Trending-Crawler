...
## python
+ [Reddit-Stock-Trends](https://github.com/iam-abbas/Reddit-Stock-Trends)(**256 stars today**): Fetch currently trending stocks on Reddit
+ [YYeTsBot](https://github.com/tgbot-collection/YYeTsBot)(**219 stars today**): 🎬人人影视bot，完全对接人人影视全部无删减资源
+ [awx](https://github.com/ansible/awx)(**26 stars today**): AWX Project
+ [calib_challenge](https://github.com/commaai/calib_challenge)(**5 stars today**): The comma.ai Calibration Challenge!
+ [sentry](https://github.com/getsentry/sentry)(**6 stars today**): Sentry is cross-platform application monitoring, with a focus on error reporting.
...
+ [SeaLion](https://github.com/anish-lakkapragada/SeaLion)(**34 stars today**): The first machine learning framework that encourages learning ML concepts instead of memorizing class functions.
...
+ [public-apis](https://github.com/public-apis/public-apis)(**81 stars today**): A collective list of free APIs for use in software and web development.
...
## java
+ [mlkit](https://github.com/googlesamples/mlkit)(**34 stars today**): A collection of sample apps to demonstrate how to use Google's ML Kit APIs on Android and iOS
...
## unknown
+ [1s](https://github.com/justjavac/1s)(**95 stars today**): 天若有情天亦老，我为网站加一秒
+ [awesome-libra](https://github.com/reed-hong/awesome-libra)(**205 stars today**): A Curated List of Awesome Facebook Libra Resources
+ [lolMiner-releases](https://github.com/Lolliedieb/lolMiner-releases)(**14 stars today**): 
+ [Free-Certifications](https://github.com/cloudcommunity/Free-Certifications)(**98 stars today**): Curated list of free courses & certifications
+ [selling-partner-api-docs](https://github.com/amzn/selling-partner-api-docs)(**2 stars today**): This repository contains documentation for developers to use to call Selling Partner APIs.
+ [market-toolkit](https://github.com/ckz8780/market-toolkit)(**9 stars today**): A collection of stock market resources and tools
+ [idiomatic.js](https://github.com/rwaldron/idiomatic.js)(**3 stars today**): Principles of Writing Consistent, Idiomatic JavaScript
+ [Nmap](https://github.com/Y000o/Nmap)(**10 stars today**): 
+ [modern-js-cheatsheet](https://github.com/mbeaudru/modern-js-cheatsheet)(**13 stars today**): Cheatsheet for the JavaScript knowledge you will frequently encounter in modern projects.
+ [free-programming-books](https://github.com/EbookFoundation/free-programming-books)(**152 stars today**): 📚Freely available programming books
...
+ [AZ-900T0x-MicrosoftAzureFundamentals](https://github.com/MicrosoftLearning/AZ-900T0x-MicrosoftAzureFundamentals)(**0 stars today**): Microsoft Azure Fundamentals - AZ-900T00 and AZ-900T01
...
+ [intellij-community](https://github.com/JetBrains/intellij-community)(**8 stars today**): IntelliJ IDEA Community Edition & IntelliJ Platform
...
+ [Android-Penetration-Testing](https://github.com/Ignitetechnologies/Android-Penetration-Testing)(**0 stars today**): 
...
## javascript
+ [nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)(**187 stars today**): ✅The Node.js best practices list (February 2021)
+ [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)(**185 stars today**): 🛁Clean Code concepts adapted for JavaScript
+ [gaze-detection](https://github.com/charliegerard/gaze-detection)(**88 stars today**): 👀Use machine learning in JavaScript to detect eye movements and build gaze-controlled experiences.
+ [Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)(**183 stars today**): 24 Lessons, 12 Weeks, Get Started as a Web Developer
...
+ [discord-open-source](https://github.com/discord/discord-open-source)(**24 stars today**): List of open source communities living on Discord
+ [turbo-rails](https://github.com/hotwired/turbo-rails)(**6 stars today**): Use Turbo in your Ruby on Rails app
+ [iptv](https://github.com/iptv-org/iptv)(**381 stars today**): Collection of 5000+ publicly available IPTV channels from all over the world
...
+ [cypress](https://github.com/cypress-io/cypress)(**24 stars today**): Fast, easy and reliable testing for anything that runs in a browser.
...
+ [Scripts](https://github.com/Sunert/Scripts)(**12 stars today**): 
...
+ [gridsome](https://github.com/gridsome/gridsome)(**18 stars today**): ⚡️The Jamstack framework for Vue.js
...
+ [supercookie](https://github.com/jonasstrehle/supercookie)(**243 stars today**): ⚠️Browser fingerprinting via favicon!
...
## go
+ [vault](https://github.com/hashicorp/vault)(**257 stars today**): A tool for secrets management, encryption as a service, and privileged access management
...
+ [kubevirt](https://github.com/kubevirt/kubevirt)(**12 stars today**): Kubernetes Virtualization API and runtime in order to define and manage virtual machines.
+ [learngo](https://github.com/inancgumus/learngo)(**103 stars today**): 1000+ Hand-Crafted Go Examples, Exercises, and Quizzes
+ [elrond-go](https://github.com/ElrondNetwork/elrond-go)(**13 stars today**): ⚡Elrond-GO: The official implementation of the Elrond protocol, written in golang.
+ [trivy](https://github.com/aquasecurity/trivy)(**92 stars today**): A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
+ [kratos](https://github.com/ory/kratos)(**11 stars today**): Next-gen identity server (think Auth0, Okta, Firebase) with ORY-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headles, API-only - without templating or themeing headaches.
+ [tendermint](https://github.com/tendermint/tendermint)(**4 stars today**): ⟁ Tendermint Core (BFT Consensus) in Go
+ [sorg](https://github.com/brandur/sorg)(**4 stars today**): A Go-based static site generator that compiles brandur.org.
+ [esbuild](https://github.com/evanw/esbuild)(**73 stars today**): An extremely fast JavaScript bundler and minifier
...
+ [iamlive](https://github.com/iann0036/iamlive)(**52 stars today**): Generate a basic IAM policy from AWS client-side monitoring (CSM)
